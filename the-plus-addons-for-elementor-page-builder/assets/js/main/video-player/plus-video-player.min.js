...
!function(t){"use strict";t(document).on("click",".tpae-video-a11y__btn",function(e){e.preventDefault();var n=this,a=n.closest(".ts-video-wrapper"),i=a?a.querySelector("video"):null;i&&(i.paused?(i.play(),n.setAttribute("aria-pressed","false"),n.textContent=n.getAttribute("data-tpae-label-pause")):(i.pause(),n.setAttribute("aria-pressed","true"),n.textContent=n.getAttribute("data-tpae-label-play")))})}(jQuery);
