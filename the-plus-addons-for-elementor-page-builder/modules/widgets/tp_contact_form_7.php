 ...
 */
class ThePlus_Contact_Form_7 extends Plus_Widget_Base {
	 ...
	 * render() delegates to Contact Form 7's own shortcode, which embeds a
	 ...
	 * token, which CF7 will treat as invalid on submit. Must stay `true`
	 * (COMPAT-001).
	 *
	 * @since 6.0.6
	 */
