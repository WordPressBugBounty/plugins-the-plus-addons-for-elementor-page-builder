		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 16 , 2024 <span class="changelog-version">Lite Version 5.6.14</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Improvement : Unnecessary code removed for better performance.', 'tpebl').'</li>';
						echo '<li>'.esc_html__('Accordion : Security Patch Conflict With Logout User.', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 16 , 2024 <span class="changelog-version">Pro Version 5.6.7</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Improvement : Unnecessary code removed for better performance.', 'tpebl').'</li>';
