		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 09 , 2024 <span class="changelog-version">Lite Version 5.6.12</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Update : Accordion : Security Patch ( Low security )', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 01 , 2024 <span class="changelog-version">Pro Version 5.6.6</span></div>';
						echo '<ul class="changelog-list">';
